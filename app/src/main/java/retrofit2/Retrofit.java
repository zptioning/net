...
public final class Retrofit {
     ...
     * </pre>
     *
     * @param service : GitHubService.class
     */
                ...
                new InvocationHandler() {
                    ...
                    Object invoke(Object proxy, Method method,
                        ...
                        if (method.getDeclaringClass() == Object.class) {
                          /* zp add Object的方法 直接调用 */
                            return method.invoke(this, args);
                        }
                        if (platform.isDefaultMethod(method)) {
                          /* zp add java8以上接口的默认方法 直接调用 */
    ...
    private void validateServiceInterface(Class<?> service) {
        /* zp add 不是接口就抛异常 GitHubService.class */
        ...
        while (!check.isEmpty()) {
            ...
            /* zp add 有TypeParameters 就报错， 就是泛型 <T> */
            ...
            /* zp add 将当前接口继承的接口再添加 check队列 */
            Collections.addAll(check, candidate.getInterfaces());
        }

        /* zp add retrofit 的api 接口 的方法 遍历 初始化 */
        if (validateEagerly) {
